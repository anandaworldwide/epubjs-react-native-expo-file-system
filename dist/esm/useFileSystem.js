...
export function useFileSystem() {
    ...
    var _d = useState(0), size = _d[0], setSize = _d[1];
    var _e = useState(null), error = _e[0], setError = _e[1];
    var _f = useState(false), success = _f[0], setSuccess = _f[1];
    var downloadFile = useCallback(function (fromUrl, toFile) {
    ...
    var getFileInfo = useCallback(function (fileUri) { return __awaiter(_this, void 0, void 0, function () {
        var result;
