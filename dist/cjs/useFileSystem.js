...
function useFileSystem() {
    ...
    var _c = (0, react_1.useState)(false), downloading = _c[0], setDownloading = _c[1];
    var _d = (0, react_1.useState)(0), size = _d[0], setSize = _d[1];
    var _e = (0, react_1.useState)(null), error = _e[0], setError = _e[1];
    var _f = (0, react_1.useState)(false), success = _f[0], setSuccess = _f[1];
    var downloadFile = (0, react_1.useCallback)(function (fromUrl, toFile) {
        var destPath = FileSystem.documentDirectory + toFile;
        var callback = function (downloadProgress) {
            var currentProgress = Math.round((downloadProgress.totalBytesWritten /
                downloadProgress.totalBytesExpectedToWrite) *
                100);
            setProgress(currentProgress);
        };
        var downloadResumable = FileSystem.createDownloadResumable(fromUrl, destPath, { cache: true }, callback);
        setDownloading(true);
        return downloadResumable
            ...
            .finally(function () { return setDownloading(false); });
    }, []);
    var getFileInfo = (0, react_1.useCallback)(function (fileUri) { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, FileSystem.getInfoAsync(fileUri)];
                case 1:
                    result = (_a.sent());
                    return [2 /*return*/, {
                            uri: result.uri,
